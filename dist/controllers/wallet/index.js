...
class WalletService extends svc_1.GenericService {
    constructor() {
        ...
        this.getTransactions = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (txs.length === (this.transactions && this.transactions.length)) {
        ...
        this.getDomainName = (name) => __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign({}, info, { owned: !!coin, ownerCovenantType: typesByVal[coin && coin.covenant.type] });
        });
        this.getDomainNames = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < domains.length; i++) {
                ...
                const { owner } = domain;
                const state = domain.state(latestBlock && latestBlock.height, this.network);
                ...
                result.push(Object.assign({}, domain.format(latestBlock && latestBlock.height, this.network), { owned: !!coin, ownerCovenantType: typesByVal[coin.covenant.type] }));
            }
            this.domains = result;
            yield pushMessage({
                type: ActionTypes.SET_DOMAIN_NAMES,
